...
0x00003044  0x1000ffff  beq $0,$0,0xffffffff  18   dead: beq  $0,$0,dead   # program is over, keep looping back to here
  ...
  /* test program 3 .text at 0x00003000 .data at 0x00000000
Address    Code        Basic
0x00003000  0x8c010014  lw r1, $20(r0)	1
0x00003004  0x8c060015  lw r6, $21(r0)  2
0x00003008  0x00001820  add r3,r0,r0    3
0x0000300c  0x00002020  add r4,r0,r0    4
0x00003010  0x00002820  add r5,r0,r0    5
0x00003014  0x00411020  add r2,r2,r1    6
0x00003018  0x00611822  sub r3,r3,r1    7
0x0000301c  0x00812024  and r4,r4,r1    8
0x00003020  0x00a12827  nor r5,r5,r1    9
0x00003024  0x1041fff8  beq r2,r1,-8    10
  */
  val prog3 = Array(
    UInt("h8c010014"),
    UInt("h8c060015"),
